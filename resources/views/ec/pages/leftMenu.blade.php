...
{{-- 
 ...
 --}}
  ...
  <ul class="leftMenu"> 
    <li><a href="{{ $url_w_mo }}/main/Main.jsp?cid=memb&oid=back2hp&mdiv=1099800000-bt_0_150_01-bt_0_150_01_e1&ctype=B" title="{{ $momogo }} - 首頁"><p></p>回首頁</a></li> 
    <li class="appDownloadbtn insuranceBtn"><a href="{{ $url_w_mo }}/fuli/redirect.jsp?redirect_url=//www.momo5188.com" title="momo富立保險"><p></p>momo富立保險</a></li> 
    <li class="appDownloadbtn"><a href="{{ $url_w_mo }}/edm/edm.jsp?lpn=Nzpe4YTLgeM&n=1&cid=memb&oid=APP&mdiv=1099800000-bt_0_150_01-bt_0_150_01_e3" title="APP下載"><p></p>APP下載</a></li> 
